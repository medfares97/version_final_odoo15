        ...
        if current.project_id:
            if current.type == '1':
                if not current.task_ids:
                    raise ValueError(_('Action impossible!'), _("Vous devez sélectionner les étapes/kits concernées!"))
                if not current.line_ids:
                    raise ValueError(_('Action impossible!'), _("Vous devez Mentionner les Zones et Secteurs!"))
                ...
                if len(l) > 0:
                    ...
                    if not ll1:
                        raise ValueError(_('Action impossible!'), _("Merci de sauvegarder le document avant!"))
                    else:
                        for nn in ll1:
